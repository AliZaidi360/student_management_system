        ...
        <main class="main-content">
            ...
            <div class="card">
                ...
                <div style="display: flex; gap: 1rem; flex-wrap: wrap;">
                    ...
                    <a href="view_students.php" class="btn btn-outline"><i class="fas fa-list"></i> View
                        Students</a>
                    <a href="add_course.php" class="btn btn-outline"><i class="fas fa-plus"></i> Add Course</a>
                    <a href="attendance.php" class="btn btn-outline"><i class="fas fa-check"></i> Take
                        Attendance</a>
                </div>
            </div>
        </main>
